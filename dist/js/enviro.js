...
if (typeof console == "undefined") var console = { log: function log() {} };
...
function createWorld() {
	...
	for (var x = 0; x < wareWidth; x++) {
		for (var y = 0; y < 14; y++) {
			if (Math.random() > 0.98) warehouse[x][y] = 1;
		}
	}
	...
	while (currentPath.length == 0) {
		...
		if (warehouse[pathStart[0]][pathStart[1]] == 0) currentPath = findPath(warehouse, pathStart, pathEnd);
	}
	redraw();
}
